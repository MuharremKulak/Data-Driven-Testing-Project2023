package com.academy.muharremkulak.testCasesAll.testCase15;
...
public class PlaceOrder_RegisterBeforeCheckoutTest extends BaseTest {
    ...
    public void PlaceOrder_RegisterBeforeCheckoutPageTest(Map<String, String> data) throws InterruptedException {
        ...
        extentTest = extentReports.startTest("Place Order: Register Before Checkout Test");
